...
public class Demo1 extends Configured implements Tool {	
	...
	public int run(String[] args) throws Exception 
	{
		...
		job.setJarByClass(Demo1.class);								//指定Class
	...
	public static void main(String[] args) throws Exception 
	{
		...
		if ( args.length != 2 )
		{
			...
			System.err.println("Example: hadoop jar ~/Test_2.jar hdfs://namenode:9000/home/hadoop/Test_2 hdfs://namenode:9000/home/hadoop/output");
		...
		//运行任务
		int res = ToolRunner.run(new Configuration(), new Demo1(), args);
